            ...
            <div class="card-header pb-0">
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <!-- Modal Tambah Menu -->
                        <div class="modal fade" id="modalUserAdd" tabindex="-1" aria-labelledby="addModalLabel"
                            aria-hidden="true">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" class="form-control" placeholder="80000000000"
                                                        name="whatsapp">
                                                </div>
                                            </div>
                                            <div class="col-12 col-lg-6">
                            ...
                            <table class="table align-items-center mb-0" id="data-table">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($users->result() as $u): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="avatar avatar-xl position-relative">
                                                    <img src="<?= base_url('assets/img/users/' . $u->image); ?>"
                                                        alt="user_image" class="w-100 border-radius-lg shadow-sm">
                                                </div>
                                            </td>
                                            <td>
                                                <p class="text-xs font-weight-bold mb-0 px-3">
                                                ...
                                                <td class="align-middle text-center text-sm">
                                                    <div class="btn-group w-100 w-lg-auto">
                                                        <button type="button" class="btn btn-success btn-sm px-3"
                                                            ...
                                                            data-bs-target="#modalUserDetail<?= $u->id_user; ?>"><i
                                                                class="fa fa-user cursor-pointer"></i></button>
                                                        <button type="button" class="btn btn-primary btn-sm px-3"
                                                            data-bs-toggle="modal"
                                                            data-bs-target="#modalUserEdit<?= $u->id_user; ?>"><i
                                                                class="fa fa-edit cursor-pointer"></i></button>
                                                        <button type="button" class="btn btn-danger btn-sm px-3"
                                                            data-bs-toggle="modal"
                                                            data-bs-target="#modalUserDelete<?= $u->id_user; ?>"><i
                                        ...
                                        <!-- Modal Detail User -->
                                        <div class="modal fade" id="modalUserDetail<?= $u->id_user; ?>" tabindex="-1"
                                            aria-labelledby="DetailModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="DetailModalLabel">Detail Data Pengguna
                                                        </h5>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-6">
                                                                ...
                                                                <div class="mb-3">
                                                                    <label>Whatsapp</label>
                                                                    <p class="ms-1 text-sm">
                                                                        <a href="https://api.whatsapp.com/send?phone=62<?= $u->whatsapp; ?>"
                                                                            target="blank"><?= $u->whatsapp; ?></a>
                                                                    </p>
                                                                </div>

                                                                <div class="mb-3">
                                                                    <label>Icon</label>
                                                                    <p class="ms-1 text-sm"><i class="<?= $u->icon; ?>"></i>
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        <!-- Modal Edit User -->
                                        <div class="modal fade" id="modalUserEdit<?= $u->id_user; ?>" tabindex="-1"
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-12 col-lg-6">
                                                                <div class=" mb-3">
                                                                    ...
                                                                    <select class="form-select" aria-label="Default select"
                                                                        name="role_id">
                                                                        <option value="<?= $u->id_role; ?>"><?= $u->role ?>
                                                                        </option>
                                                                        <?php foreach ($role->result() as $r): ?>
                                                                            <option value="<?= $r->id_role ?>"><?= $r->role ?>
                                                                            </option>
                                                                        <?php endforeach; ?>
                                                                    </select>
                                                                </div>
                                                            ...
                                                            <div class="col-12 col-lg-6">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="number" class="form-control"
                                                                        placeholder="80000000000" name="whatsapp"
                                                                        value="<?= $u->whatsapp; ?>">
                                                                </div>
                                                            </div>
                                                            <div class="col-12 col-lg-6">
                                                            ...
                                                            <div class="col-12">
                                                                <p class="text-sm small"><small><i><span
                                                                                class="text-danger">*</span>(Kosongkan jika
                                                                            tidak ada perubahan)</i></small></p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="modal-footer">
                                        ...
                                        <!-- Modal Hapus User -->
                                        <div class="modal fade" id="modalUserDelete<?= $u->id_user; ?>" tabindex="-1"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form role="form" action="<?= base_url('pengguna/user_delete') ?>"
                                                        method="POST">
                                                        <div class="modal-body">
                                                            <div class="mb-3">
                                                                <input type="hidden" name="id_user"
                                                                    value="<?= $u->id_user; ?>">
                                                                <p class="text-sm mt-3">Yakin ingin menghapus pengguna :
