        ...
        <div class="row">
            ...
            <div class="col-lg-4">
              ...
              background-size: cover; background-position: center;">
                            ...
                            <div class="carousel-item h-100" style="background-image: url('assets/img/carousel-1.jpg');
                              background-size: cover; background-position: center;">
                                <div class="carousel-caption d-none d-md-block bottom-0 text-start start-0 ms-5">
                                    ...
                                    <h5 class="text-white mb-1">Andika Nurhidayat, S.Pd.</h5>
                                    <p>Bendahara</p>
                                    <div class="d-flex justify-content-start">
                                        <div class="d-grid text-center">
                                            <a href="">
                            ...
                            <div class="carousel-item h-100" style="background-image: url('assets/img/anas.jpg');
              background-size: cover; background-position: center;">
                                <div class="carousel-caption d-none d-md-block bottom-0 text-start start-0 ms-5">
                                    <div class="icon icon-shape icon-sm bg-white text-center border-radius-md mb-3">
                                        <i class="ni ni-bulb-61 text-dark opacity-10"></i>
                                    </div>
                                    <h5 class="text-white mb-1">Eka Anas Jatnika, M.Ds</h5>
                                    <p>Produk</p>
                                    <div class="d-flex justify-content-start">
                                        <div class="d-grid text-center">
                                            <a href="">
                            ...
                            <div class="carousel-item h-100" style="background-image: url('assets/img/carousel-3.jpg');
                              background-size: cover; background-position: center;">
                                <div class="carousel-caption d-none d-md-block bottom-0 text-start start-0 ms-5">
                                    ...
                                    <h5 class="text-white mb-1">Moch Angga Kusumah, S.Pd.</h5>
                                    <p>Peralatan dan Perlengkapan</p>
                                    <div class="d-flex justify-content-start">
                                        <div class="d-grid text-center">
                                            <a href="">
                                                <span class="text-white opacity-8"><i class="fa fa-facebook"></i></span>
