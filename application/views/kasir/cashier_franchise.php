                                    ...
                                    <?php foreach ($selling->result() as $s) : ?>
                                        <tr>
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                <a type="button" class="badge bg-warning btn-sm px-3 py-2 rounded-pill" href="<?= base_url('kasir/selling_franchise_detail/?date_selling=') . $s->date_selling . '&id_lab=' . $s->id_lab; ?>"><i class="fa fa-list cursor-pointer"> </i> Detail</a>
