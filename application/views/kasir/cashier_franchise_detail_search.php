        ...
        <div class="card mb-4">
            <div class="card-header pb-0">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="btn-group float-end w-100 w-lg-auto">
                                    <a href="<?= base_url('kasir/selling_franchise/?id_lab=') . $lab; ?>" class="btn btn-primary btn-sm mb-3">
                                        Kembali
                                    </a>
                ...
                <div class="row justify-content-end">
                    <div class="col-12 col-lg-6">
                        <form role="form" action="<?= base_url('kasir/selling_franchise_detail_search') ?>" method="GET">
                            <div class="row">
