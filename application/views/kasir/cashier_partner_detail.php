            ...
            <div class="card-header pb-0">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="btn-group float-end w-100 w-lg-auto">
                                    <a href="<?= base_url('kasir/selling_partner/?id_lab=') . $lab; ?>"
                ...
                <div class="row justify-content-end">
                    <div class="col-12 col-lg-6">
                        <form role="form" action="<?= base_url('kasir/selling_partner_detail_search') ?>" method="GET">
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-8 col-lg-6 my-2">
                                    <select class="form-select" aria-label="Default select" name="id_partner">
                                        ...
                                        <?php foreach ($partner->result() as $f): ?>
