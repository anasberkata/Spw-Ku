            ...
            <div class="card-header pb-0">
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <div class="modal fade" id="modalCategoryAdd" tabindex="-1" aria-labelledby="addModalLabel"
                            aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="<?= base_url('peralatan/category_add') ?>" method="POST">
                            ...
                            <table class="table align-items-center mb-0" id="data-table">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($category->result() as $c): ?>
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                <div class="btn-group w-100 w-lg-auto">
                                                    <button type="button" class="btn btn-primary btn-sm px-3 py-2"
                                                        ...
                                                        data-bs-target="#modalCategoryEdit<?= $c->id_tool_category; ?>"><i
                                                            class="fa fa-edit cursor-pointer"></i></button>
                                                    <button type="button" class="btn btn-danger btn-sm px-3 py-2"
                                                        type="button" data-bs-toggle="modal"
                                                        data-bs-target="#modalCategoryDelete<?= $c->id_tool_category; ?>"><i
                                        ...
                                        <!-- Modal Edit Kategori -->
                                        <div class="modal fade" id="modalCategoryEdit<?= $c->id_tool_category; ?>"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form role="form" action="<?= base_url('peralatan/category_edit') ?>"
                                                        method="POST">
                                                        <div class="modal-body">
                                                            <input type="hidden" name="id_category"
                                                                value="<?= $c->id_tool_category; ?>">
                                                            <div class="mb-3">
                                                                <label>Katagori</label>
                                                                <input type="text" class="form-control"
                                                                    placeholder="Nama Kategori" name="category"
                                                                    value="<?= $c->tool_category; ?>">
                                                            </div>
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary btn-sm"
                                        ...
                                        <div class="modal fade" id="modalCategoryDelete<?= $c->id_tool_category; ?>"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form role="form" action="<?= base_url('peralatan/category_delete') ?>"
                                                        method="POST">
                                                        <div class="modal-body">
                                                            <div class="mb-3">
                                                                <input type="hidden" name="id_category"
                                                                    value="<?= $c->id_tool_category; ?>">
                                                                <p class="text-sm mt-3">Yakin ingin menghapus kategori :
