                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="btn-group float-end w-100 w-lg-auto">
                            <button type="button" class="btn btn-dark btn-sm mb-3 float-end" data-bs-toggle="modal" data-bs-target="#modalScheduleAdd">
                                Tambah
                            </button>
                        </div>

                        <!-- Modal Tambah Menu -->
                        <div class="modal fade" id="modalScheduleAdd" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true">
                            ...
                            <table class="table align-items-center mb-0" id="data-table">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($schedule->result() as $s) : ?>
                                        ...
                                        <!-- Modal Edit Role -->
                                        <div class="modal fade" id="modalScheduleEdit<?= $s->id_schedule; ?>" tabindex="-1" aria-labelledby="EditModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                        ...
                                        <!-- Modal Hapus Role -->
                                        <div class="modal fade" id="modalScheduleDelete<?= $s->id_schedule; ?>" tabindex="-1" aria-labelledby="DeleteModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                    ...
                                                    <form role="form" action="<?= base_url('data/schedule_delete') ?>" method="POST">
                                                        <div class="modal-body">
                                                            <div class="mb-3">
                                                                ...
                                                                <p class="text-sm mt-3">Yakin ingin menghapus jadwal : <span class="text-bold"><?= date('d F Y', strtotime($s->picket_schedule)); ?></span>!</p>
                                                            </div>
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary btn-sm" data-bs-dismiss="modal">Batal</button>
