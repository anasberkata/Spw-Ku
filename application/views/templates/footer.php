    ...
    <div class="card shadow-lg">
        <div class="card-header pb-0 pt-3 ">
            <div class="float-start">
                <h5 class="mt-3 mb-0">Konfigurasi Applikasi</h5>
                <p>Ubah sesuai keinginan anda.</p>
            </div>
        ...
        <div class="card-body pt-sm-3 pt-0 overflow-auto">
            ...
            <div class="w-100 text-center">
                <h6 class="mt-3">Terima Kasih sudah menggunakan aplikasi SPW-KU</h6>
                <a href="https://www.instagram.com/anasberkata" class="btn btn-dark mb-0" target="_blank">
                    <i class="fab fa-instagram" aria-hidden="true"></i>
                </a>
                <a href="https://www.facebook.com/anasberkata" class="btn btn-dark mb-0" target="_blank">
