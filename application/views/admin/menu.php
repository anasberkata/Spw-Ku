                ...
                <div class="row">
                    ...
                    <div class="col">
                        <button type="button" class="btn btn-dark btn-sm mb-3 float-end" data-bs-toggle="modal"
                            data-bs-target="#modalMenuAdd">
                            Tambah
                        </button>

                        <!-- Modal Tambah Menu -->
                        <div class="modal fade" id="modalMenuAdd" tabindex="-1" aria-labelledby="addModalLabel"
                            aria-hidden="true">
                            ...
                            <table class="table align-items-center mb-0">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($menu->result() as $m): ?>
                                        ...
                                        <!-- Modal Edit Menu -->
                                        <div class="modal fade" id="modalMenuEdit<?= $m->id_user_menu; ?>" tabindex="-1"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form role="form" action="<?= base_url('admin/menu_edit') ?>"
                                                        method="POST">
                                                        <div class="modal-body">
                                                            <input type="hidden" name="id_user_menu"
                                                                value="<?= $m->id_user_menu; ?>">
                                                            <div class="mb-3">
                                                                <label>Nama Menu</label>
                                                                <input type="text" class="form-control"
                                                                    placeholder="Nama Menu" name="menu"
                                                                    value="<?= $m->menu; ?>">
                                                            </div>
                                                            <div class="mb-3">
                                                                <label>Urutan Menu</label>
                                                                <input type="number" class="form-control"
                                                                    placeholder="Urutan Menu" name="order_menu"
                                                                    value="<?= $m->order_menu; ?>">
                                                            </div>
                                                        </div>
                                                        <div class="modal-footer">
                                        ...
                                        <!-- Modal Hapus Menu -->
                                        <div class="modal fade" id="modalMenuDelete<?= $m->id_user_menu; ?>" tabindex="-1"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form role="form" action="<?= base_url('admin/menu_delete') ?>"
                                                        method="POST">
                                                        <div class="modal-body">
                                                            <div class="mb-3">
                                                                <input type="hidden" name="id_user_menu"
                                                                    value="<?= $m->id_user_menu; ?>">
                                                                <p class="text-sm mt-3">Yakin ingin menghapus menu : <span
                                                                        class="text-bold">
                                                                        <?= $m->menu; ?>
                                                                    </span>!</p>
                                                            </div>
        ...
        <div class="card mb-4">
            <div class="card-header pb-0">
                <div class="row">
                    ...
                    <div class="col">
                        <button type="button" class="btn btn-dark btn-sm mb-3 float-end" data-bs-toggle="modal"
                            data-bs-target="#modalSubmenuAdd">
                            Tambah
                        </button>

                        <!-- Modal Tambah Submenu -->
                        <div class="modal fade" id="modalSubmenuAdd" tabindex="-1" aria-labelledby="addModalLabel"
                            aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            placeholder="Nama Submenu" name="title">
                                                    </div>
                                                </div>
                                                <div class="col-12 col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-select" aria-label="Default select"
                                                            ...
                                                            <?php foreach ($menu->result() as $m): ?>
                                                                <option value="<?= $m->id_user_menu ?>"><?= $m->menu ?>
                                                                </option>
                                                            <?php endforeach; ?>
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="col-12 col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" class="form-control"
                                                            placeholder="Urutan Submenu" name="order_submenu">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($submenu->result() as $sm): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <p class="text-xs font-weight-bold mb-0 px-3"><i
                                                        class="<?= $sm->icon; ?>"></i></p>
                                            </td>
                                            <td>
                                                <p class="text-xs font-weight-bold mb-0 px-3">
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                <div class="btn-group w-100 w-lg-auto">
                                                    <button type="button" class="btn btn-primary btn-sm px-3 py-2"
                                                        ...
                                                        data-bs-target="#modalSubmenuEdit<?= $sm->id_user_submenu; ?>"><i
                                                            class="fa fa-edit cursor-pointer"></i></button>
                                                    <button type="button" class="btn btn-danger btn-sm px-3 py-2"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#modalSubmenuDelete<?= $sm->id_user_submenu; ?>"><i
                                                            class="fa fa-trash cursor-pointer"></i></button>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <!-- Modal Edit Menu -->
                                        <div class="modal fade" id="modalSubmenuEdit<?= $sm->id_user_submenu; ?>"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form role="form" action="<?= base_url('admin/submenu_edit') ?>"
                                                        method="POST">
                                                        <div class="modal-body">
                                                            <input type="hidden" name="id_user_submenu"
                                                                value="<?= $sm->id_user_submenu; ?>">
                                                            <div class="row">
                                                                <div class="col-12 col-lg-6">
                                                                    <div class="mb-3">
                                                                        <label>Nama Submenu</label>
                                                                ...
                                                                <div class="col-12 col-lg-6">
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <select class="form-select"
                                                                            aria-label="Default select" name="menu_id">
                                                                            <option value="<?= $sm->menu_id; ?>" selected>
                                                                                <?= $sm->menu; ?></option>
                                                                            <?php foreach ($menu->result() as $m): ?>
                                                                                <option value="<?= $m->id_user_menu ?>"><?=
                                                                                      $m->menu ?></option>
                                                                            <?php endforeach; ?>
                                                                        </select>
                                                                    </div>
                                                                ...
                                                                <div class="col-12 col-lg-6">
                                                                    <div class="mb-3">
                                                                        <label>Urutan Submenu</label>
                                                                        <input type="number" class="form-control"
                                                                            placeholder="Urutan Submenu"
                                                                            name="order_submenu"
                                                                            value="<?= $sm->order_submenu; ?>">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        <!-- Modal Hapus Menu -->
                                        <div class="modal fade" id="modalSubmenuDelete<?= $sm->id_user_submenu; ?>"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form role="form" action="<?= base_url('admin/submenu_delete') ?>"
                                                        method="POST">
                                                        <div class="modal-body">
                                                            <div class="mb-3">
                                                                <input type="hidden" name="id_user_submenu"
                                                                    value="<?= $sm->id_user_submenu; ?>">
                                                                <p class="text-sm mt-3">Yakin ingin menghapus submenu :
