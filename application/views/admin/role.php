                ...
                <div class="row">
                    ...
                    <div class="col">
                        <button type="button" class="btn btn-dark btn-sm mb-3 float-end" data-bs-toggle="modal"
                            data-bs-target="#modalRoleAdd">
                            Tambah
                        </button>

                        <!-- Modal Tambah Menu -->
                        <div class="modal fade" id="modalRoleAdd" tabindex="-1" aria-labelledby="addModalLabel"
                            aria-hidden="true">
                            ...
                            <table class="table align-items-center mb-0" id="table1">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($role->result() as $r): ?>
                                        <tr>
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                <div class="btn-group w-100 w-lg-auto">
                                                    <a type="button" class="btn btn-success btn-sm px-3 py-2"
                                                        href="<?= base_url('admin/roleaccess/') . $r->id_role; ?>"><i
                                                            class="fa fa-key cursor-pointer"></i></a>
                                                    <button type="button" class="btn btn-primary btn-sm px-3 py-2"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#modalRoleEdit<?= $r->id_role; ?>"><i
                                                            class="fa fa-edit cursor-pointer"></i></button>
                                                    <button type="button" class="btn btn-danger btn-sm px-3 py-2"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#modalRoleDelete<?= $r->id_role; ?>"><i
                                        ...
                                        <!-- Modal Edit Role -->
                                        <div class="modal fade" id="modalRoleEdit<?= $r->id_role; ?>" tabindex="-1"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form role="form" action="<?= base_url('admin/role_edit') ?>"
                                                        method="POST">
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    placeholder="Nama Role" name="role"
                                                                    value="<?= $r->role; ?>">
                                                            </div>
                                                        </div>
                                                        <div class="modal-footer">
                                        ...
                                        <!-- Modal Hapus Role -->
                                        <div class="modal fade" id="modalRoleDelete<?= $r->id_role; ?>" tabindex="-1"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form role="form" action="<?= base_url('admin/role_delete') ?>"
                                                        method="POST">
                                                        <div class="modal-body">
                                                            <div class="mb-3">
                                                                <input type="hidden" name="id_role"
                                                                    value="<?= $r->id_role; ?>">
                                                                <p class="text-sm mt-3">Yakin ingin menghapus role : <span
                                                                        class="text-bold">
                                                                        <?= $r->role; ?>
                                                                    </span>!</p>
                                                            </div>
