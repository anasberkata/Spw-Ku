                        ...
                        <div class="modal fade" id="modalProductAdd" tabindex="-1" aria-labelledby="addModalLabel"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <?= form_open_multipart('mitra/partner_product_add'); ?>
                                    <div class="modal-body">
                                        <div class="row">
                                            <input type="hidden" class="form-control" name="id_user"
                                                value="<?= $partner['id_user']; ?>">
                                            <div class="col-12 col-lg-6">
                                                <div class="mb-3">
                                                    <label>Lab SPW</label>
                    ...
                    <div class="col-12">
                        <div class="table-responsive p-0 mb-3">
                            <table class="table align-items-center mb-0" id="data-table">
                                ...
                                <tbody>
                                    <?php $i = 1; ?>
                                    <?php foreach ($partner_product->result() as $p): ?>
                                        <tr>
                                            <td>
                                        ...
                                        <div class="modal fade" id="modalProductEdit<?= $p->id_product; ?>" tabindex="-1"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <?= form_open_multipart('mitra/partner_product_edit'); ?>
                                                    <div class="modal-body">
                                        ...
                                        <div class="modal fade" id="modalProductDelete<?= $p->id_product; ?>" tabindex="-1"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form role="form"
                                                        action="<?= base_url('mitra/partner_product_delete') ?>"
                                                        method="POST">
                                                        <div class="modal-body">
                                                            <div class="mb-3">
