                        ...
                        <div class="modal fade" id="modalFranchisorAdd" tabindex="-1" aria-labelledby="addModalLabel"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="<?= base_url('mitra/franchisor_add'); ?>" method="POST">
                                            ...
                                            <td>
                                                <div class="btn-group w-100 w-lg-auto">
                                                    <?php foreach ($lab->result() as $l): ?>
                                                        <a href="<?= base_url('mitra/franchisor_product/?id_lab=' . $l->id_lab . '&id_user=' . $f->id_user); ?>"
                                        ...
                                        <div class="modal fade" id="modalFranchisorEdit<?= $f->id_user; ?>" tabindex="-1"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form role="form" action="<?= base_url('mitra/franchisor_edit'); ?>"
                                                        method="POST">
                                                        <div class="modal-body">
                                        ...
                                        <div class="modal fade" id="modalFranchisorDelete<?= $f->id_user; ?>" tabindex="-1"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form role="form" action="<?= base_url('mitra/franchisor_delete') ?>"
                                                        method="POST">
                                                        <div class="modal-body">
                                                            <div class="mb-3">
