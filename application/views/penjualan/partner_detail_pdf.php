                ...
                <tr class="border">
                    <td colspan="2">
                        <p class="text-xs font-weight-bold">Tanggal :
                            <?= date('d F Y', strtotime($selling["date_selling"])) ?>
                        </p>
                    </td>
                    <td class="border text-center">
                    ...
                    <td class="border text-center">
                        <p class="text-uppercase text-xs font-weight-bolder mb-0 px-3 pt-5">Total Setor <br> Mitra</p>
                        <p class="small font-weight-light mb-0 px-3">(85% Stor ke Mitra)</p>
                    </td>
                    <td class="border text-center">
                        <p class="text-uppercase text-xs font-weight-bolder mb-0 px-3 pt-5">Total Setor <br> Laba SPW</p>
                        <p class="small font-weight-light mb-0 px-3">(15% Stor ke SPW)</p>
                    </td>
                </tr>
            </thead>
            <tbody>
