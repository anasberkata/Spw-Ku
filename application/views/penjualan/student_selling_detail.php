            ...
            <div class="card-header pb-0">
                <div class="row">
                    <div class="col-12 col-lg-6">
                        <h6>Daftar Penjualan Produk Siswa :
                            <?= $student_selling["class"]; ?>
                        </h6>
                        <p class="small">
                            <?= date('d M Y', strtotime($student_selling["date_selling"])) . " // SPW " . $lab . " // Guru Piket : " . $user["name"] . " // Kelas : " . $student_selling["class"]; ?>
                        </p>
                    </div>
                    <div class="col-12 col-lg-6">
                        <div class="row">
                            <div class="col-12">
                                <div class="btn-group float-end w-100 w-lg-auto">
                                    <a href="<?= base_url('penjualan/student_selling/?id_lab=') . $lab; ?>"
                                    ...
                                    <a href="<?= base_url('penjualan/printPDF_student_selling/?id_student_selling=' . $id_student_selling . '&id_lab=' . $lab . '&id_class=' . $id_class) ?>"
                        ...
                        <div class="modal fade" id="modalProductAdd" tabindex="-1" aria-labelledby="addModalLabel"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="<?= base_url('penjualan/student_selling_detail_add') ?>"
                                        method="POST">
                                        <div class="modal-body">
                                            <input type="hidden" name="id_lab" value="<?= $lab ?>">
                                            <input type="hidden" name="id_student_selling"
                                                value="<?= $id_student_selling ?>">
                                                ...
                                                <div class="col-12 col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" class="form-control"
                                                            placeholder="Harga Dasar" name="basic_price">
                                                    </div>
                                                </div>
                                                <div class="col-12 col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" class="form-control"
                                                            placeholder="Harga Jual" name="selling_price">
                                                    </div>
                                                </div>
                                                <div class="col-12 col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" class="form-control"
                                                            placeholder="Stok Awal" name="qty_product">
                                                    </div>
                                                </div>
                                                <div class="col-12 col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" class="form-control"
                                                            placeholder="Stok Akhir" name="qty_last">
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <p class="text-sm small"><small><i><span
                                                                    class="text-danger">*</span>(Kosongkan jika tidak
                                                                ada data)</i></small></p>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($student_selling_detail->result() as $fd): ?>
                                        <tr>
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                <a type="button" class="badge bg-primary btn-sm px-3 py-2 rounded-pill"
                                                    data-bs-toggle="modal"
                                                    data-bs-target="#modalProductEdit<?= $fd->id_student_selling_detail; ?>"><i
                                                        class="fa fa-edit cursor-pointer"></i></a>
                                                |
                                                <a type="button" class="badge bg-danger btn-sm px-3 py-2 rounded-pill"
                                                    data-bs-toggle="modal"
                                                    data-bs-target="#modalProductDelete<?= $fd->id_student_selling_detail; ?>"><i
                                                        class="fa fa-trash cursor-pointer"></i></a>
                                            </td>
                                        </tr>

                                        <!-- Modal Edit Role -->
                                        <div class="modal fade" id="modalProductEdit<?= $fd->id_student_selling_detail; ?>"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form role="form"
                                                        action="<?= base_url('penjualan/student_selling_detail_edit') ?>"
                                                        method="POST">
                                                        <div class="modal-body">
                                                            <input type="hidden" name="id_lab" value="<?= $lab ?>" readonly>
                                                            <input type="hidden" name="id_student_selling"
                                                                value="<?= $id_student_selling ?>" readonly>
                                                            <input type="hidden" name="id_student_selling_detail"
                                                                value="<?= $fd->id_student_selling_detail; ?>" readonly>
                                                            <input type="hidden" name="id_class"
                                                                value="<?= $fd->id_class; ?>" readonly>
                                        ...
                                        <div class="modal fade"
                                            id="modalProductDelete<?= $fd->id_student_selling_detail; ?>" tabindex="-1"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form role="form"
                                                        action="<?= base_url('penjualan/student_selling_detail_delete') ?>"
                                                        method="POST">
                                                        <div class="modal-body">
                                                            <div class="mb-3">
                                                                <input type="hidden" name="id_lab" value="<?= $lab; ?>">
                                                                <input type="hidden" name="id_student_selling"
                                                                    value="<?= $fd->id_student_selling; ?>">
                                                                <input type="hidden" name="id_student_selling_detail"
                                                                    value="<?= $fd->id_student_selling_detail; ?>">
                                                                <input type="hidden" name="id_class"
                                                                    value="<?= $fd->id_class; ?>">
                                    ...
                                    <?php else: ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <p class="text-uppercase text-xs font-weight-bolder mb-0 px-3 pt-5">Jumlah
                                                    Setor <br> 20% Laba <br> Penjualan</p>
                                                <p class="text-xs mb-0 px-3">(Disetorkan ke <br> SPW)</p>
                                            </td>
                                            <td>
                                                <p class="text-uppercase text-xs font-weight-bolder mb-0 px-3 pt-5">Jumlah
                                                    Setor <br> 80% laba <br> Penjualan</p>
