                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($franchisor->result() as $f) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <p class="text-xs font-weight-bold mb-0 px-3"><a href="https://wa.me/62<?= $f->whatsapp; ?>" target="blank" class="btn btn-success btn-sm mt-3"><i class="fa fa-whatsapp"></i></a></p>
                                            </td>
