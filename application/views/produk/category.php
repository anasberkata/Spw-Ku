                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                <div class="btn-group w-100 w-lg-auto mt-3">
                                                    <button type="button" class="btn btn-primary btn-sm px-3 py-2" type="button" data-bs-toggle="modal" data-bs-target="#modalCategoryEdit<?= $c->id_category; ?>"><i class="fa fa-edit cursor-pointer"></i></button>
                                                    <button type="button" class="btn btn-danger btn-sm px-3 py-2" type="button" data-bs-toggle="modal" data-bs-target="#modalCategoryDelete<?= $c->id_category; ?>"><i class="fa fa-trash cursor-pointer"></i></button>
                                                </div>
                                            </td>
                                        </tr>
