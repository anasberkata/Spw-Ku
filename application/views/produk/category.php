                            ...
                            <table class="table align-items-center mb-0" id="data-table">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($category->result() as $c): ?>
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                <div class="btn-group w-100 w-lg-auto">
                                                    <button type="button" class="btn btn-primary btn-sm px-3 py-2"
                                                        ...
                                                        data-bs-target="#modalCategoryEdit<?= $c->id_category; ?>"><i
                                                            class="fa fa-edit cursor-pointer"></i></button>
                                                    <button type="button" class="btn btn-danger btn-sm px-3 py-2"
                                                        type="button" data-bs-toggle="modal"
                                                        data-bs-target="#modalCategoryDelete<?= $c->id_category; ?>"><i
                                        ...
                                        <!-- Modal Edit Kategori -->
                                        <div class="modal fade" id="modalCategoryEdit<?= $c->id_category; ?>" tabindex="-1"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form role="form" action="<?= base_url('produk/category_edit') ?>"
                                                        method="POST">
                                                        <div class="modal-body">
                                        ...
                                        <div class="modal fade" id="modalCategoryDelete<?= $c->id_category; ?>"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form role="form" action="<?= base_url('produk/category_delete') ?>"
                                                        method="POST">
                                                        <div class="modal-body">
                                                            <div class="mb-3">
                                                                <input type="hidden" name="id_category"
