    ...
    <div class="col-12">
        <div class="card mb-4">
            <div class="card-header pb-0">
                <div class="row">
                    <div class="col">
                        <h6>Data Pembelian Produk Lab SPW
                            <?= $lab; ?>
                        </h6>
                    </div>
                    <div class="col">
                        ...
                        <div class="btn-group float-end w-100 w-lg-auto">
                            <a href="<?= base_url('produk/index_purchase'); ?>"
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                <div class="btn-group w-100 w-lg-auto">
                                                    <a type="button" class="btn btn-warning btn-sm px-3 py-2"
                                                        href="<?= base_url('produk/purchase_detail/?id_purchase=') . $p->id_purchase . '&id_lab=' . $p->id_lab; ?>"><i
                                        ...
                                        <div class="modal fade" id="modalPurchaseEdit<?= $p->id_purchase; ?>" tabindex="-1"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form role="form" action="<?= base_url('produk/purchase_edit'); ?>"
                                                        method="POST">
                                                        <div class="modal-body">
                                                            <input type="hidden" class="form-control" name="id_lab"
                                                                value="<?= $lab; ?>">
