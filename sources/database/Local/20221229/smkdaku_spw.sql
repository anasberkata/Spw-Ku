...
(96, '8885013130997', 6, 1, 0, 'AICE 2 Colour Chocolate Stick 50 mL', -14, 1912, 2500, 'default-product.jpg', 1, 1),
...
(490, '1012022', 13, 5, 20, 'Pentol', -2, 1800, 2000, 'default-product.jpg', 1, 1);
...
--
ALTER TABLE `tbl_selling`
  MODIFY `id_selling` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;

--
-- AUTO_INCREMENT for table `tbl_selling_detail`
--
ALTER TABLE `tbl_selling_detail`
  MODIFY `id_selling_detail` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1125;
