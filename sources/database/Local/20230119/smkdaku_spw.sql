...
--
-- Host: localhost
-- Generation Time: Jan 19, 2023 at 09:18 AM
...
(81, '8992761145026', 2, 2, 0, 'Sprite Pet Imut 250 mL', 171, 2375, 3000, 'default-product.jpg', 1, 1),
(82, '8992761145033', 2, 2, 0, 'Fanta Pet Imut 250 mL', 83, 2375, 3000, 'default-product.jpg', 1, 1),
(83, '8992761145019', 2, 2, 0, 'Coca Cola Pet Imut 250 mL', 142, 2375, 3000, 'default-product.jpg', 1, 1),
...
(96, '8885013130997', 6, 1, 0, 'AICE 2 Colour Chocolate Stick 50 mL', -19, 1912, 2500, 'default-product.jpg', 1, 1),
...
(490, '1012022', 13, 5, 20, 'Pentol', -7, 1800, 2000, 'default-product.jpg', 1, 1);
...
(1125, 60, 96, 1, 1912, 2500, '2023-01-19', 1),
(1126, 61, 96, 4, 7648, 10000, '2023-01-19', 1),
...
--
ALTER TABLE `tbl_product`
  MODIFY `id_product` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=491;
...
--
ALTER TABLE `tbl_schedule`
  MODIFY `id_schedule` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=75;

--
-- AUTO_INCREMENT for table `tbl_selling`
--
ALTER TABLE `tbl_selling`
  MODIFY `id_selling` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=64;

--
-- AUTO_INCREMENT for table `tbl_selling_detail`
--
ALTER TABLE `tbl_selling_detail`
  MODIFY `id_selling_detail` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1129;
