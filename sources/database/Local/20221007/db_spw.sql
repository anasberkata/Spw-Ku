...
--
-- Host: localhost
-- Generation Time: Oct 07, 2022 at 05:52 AM
...
(297, 29, 1, 'Pempek', 1800, 2000, 100, 0, 0, 0, 0),
(298, 27, 20, 'Piscok', 2500, 3000, 10, 0, 10, 25000, 30000),
(299, 30, 20, 'cipeng', 2000, 3000, 20, 1, 19, 38000, 57000),
(300, 30, 20, 'Pentol', 1500, 2000, 120, 10, 110, 165000, 220000);
...
(139, '', 6, 1, 'AICE 2 Colors Chocolate Stick 50ml', 43, 1912, 2500, 'default-product.jpg', 2, 1),
...
(318, '', 6, 1, 'AICE Berry Choco Max Cone 100 ml', 60, 4063, 5000, 'default-product.jpg', 1, 1),
...
(20, 13, 1, 'Bala - Bala', 800, 1000, 200, 5, 195, 156000, 195000);
...
(20, 'Deri Saeful Rokhmat', 'deriaboeya@gmail.com', '', '$2y$10$qm7EHItUGi.wFA/hW1CDHe1f7S8zbwRYJNQC1jaN8hyGJPu6pjL8K', 7, 7, 'default.jpg', '', '', '', '', '2022-09-21', 1),
(23, 'Santosa Arbi Nugraha, S.Kom', '', '', '', 7, 7, 'default.jpg', '', '', '', '', '2022-10-07', 1);
...
(12, 7, 'Daftar Harga', 'daftar', 'ni ni-shop text-primary', 1, 2),
...
(21, 18, 'Data Penjualan', 'franchisor/data_franchisor', 'ni ni-cart text-success', 1, 1);
...
--
ALTER TABLE `tbl_franchise`
  MODIFY `id_franchise` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;

--
-- AUTO_INCREMENT for table `tbl_franchise_detail`
--
ALTER TABLE `tbl_franchise_detail`
  MODIFY `id_franchise_detail` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=301;
...
--
ALTER TABLE `tbl_schedule`
  MODIFY `id_schedule` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
ALTER TABLE `tbl_selling_detail`
  MODIFY `id_selling_detail` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=906;

--
-- AUTO_INCREMENT for table `tbl_student_selling`
--
ALTER TABLE `tbl_student_selling`
  MODIFY `id_student_selling` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT for table `tbl_student_selling_detail`
--
ALTER TABLE `tbl_student_selling_detail`
  MODIFY `id_student_selling_detail` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
...
--
ALTER TABLE `tbl_user_access_menu`
  MODIFY `id_user_access_menu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;

--
-- AUTO_INCREMENT for table `tbl_user_menu`
--
ALTER TABLE `tbl_user_menu`
  MODIFY `id_user_menu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
...
--
ALTER TABLE `tbl_user_submenu`
  MODIFY `id_user_submenu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
COMMIT;
