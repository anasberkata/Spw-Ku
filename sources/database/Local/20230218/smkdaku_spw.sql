...
--
-- Host: localhost
-- Generation Time: Feb 19, 2023 at 05:05 AM
...
(96, '8885013130997', 6, 1, 0, 'AICE 2 Colour Chocolate Stick 50 mL', -13, 0, 1912, 2500, 'default-product.jpg', 1, 1),
(97, '8885013130249', 6, 1, 0, 'AICE Milk Melon 50gr', 266, 0, 1913, 2500, 'default-product.jpg', 1, 1),
(98, 'SPW-098', 6, 1, 0, 'AICE Blueberry Yogurt Stick 49 mL', 0, 0, 2500, 3000, 'default-product.jpg', 1, 1),
...
(103, 'SPW-103', 6, 1, 0, 'AICE Freezy Choco 49 mL', 0, 0, 1560, 2000, 'default-product.jpg', 1, 1),
...
(129, 'SPW-129', 2, 4, 0, 'Kopikap', 110, 0, 821, 1000, 'default-product.jpg', 1, 1),
...
(430, '8885013130775', 6, 1, 0, 'AICE Durian Cup', 19, 0, 3209, 4000, 'default-product.jpg', 1, 1),
...
(471, '8991002101630', 12, 4, 0, 'ABC Susu', 0, 0, 1380, 2000, 'default-product.jpg', 1, 1),
...
(490, '1012022', 13, 5, 20, 'Pentol', -11, 0, 1800, 2000, 'default-product.jpg', 1, 1),
(491, '2334342', 13, 5, 21, 'Moring', 8, 0, 800, 1000, 'default-product.jpg', 1, 1),
...
--
ALTER TABLE `tbl_product`
  MODIFY `id_product` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=493;
...
--
ALTER TABLE `tbl_product_mutation`
  MODIFY `id_mutation` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `tbl_product_mutation_detail`
--
ALTER TABLE `tbl_product_mutation_detail`
  MODIFY `id_mutation_detail` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `tbl_user_submenu`
  MODIFY `id_user_submenu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
COMMIT;
