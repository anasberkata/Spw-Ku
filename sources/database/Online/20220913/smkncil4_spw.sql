...
--
-- Host: localhost:3306
-- Generation Time: Sep 13, 2022 at 10:48 PM
...
(90, 'SPW-090', 6, 1, 'AICE Miki-Miki 39 gr', 23, 1558, 2000, 'default-product.jpg', 1, 1),
(91, 'SPW-091', 6, 1, 'AICE Nanas Stick 65gr', 7, 1550, 2000, 'default-product.jpg', 1, 1),
(92, 'SPW-092', 6, 1, 'AICE Semangka Stick 65gr', 24, 1550, 2000, 'default-product.jpg', 1, 1),
(93, 'SPW-093', 6, 1, 'AICE Sweet Corn Stick New 52gr FIFA SS', 57, 2362, 3000, 'default-product.jpg', 1, 1),
...
(97, '', 6, 1, 'AICE Milk Melon 50gr', 34, 1913, 2500, 'default-product.jpg', 1, 1),
...
(100, '', 6, 1, 'AICE Chocolate Crispy Stick 60gr', 70, 4000, 5000, 'default-product.jpg', 1, 1),
(101, 'SPW-101', 6, 1, 'AICE Strawberry Crispy Stick New', 11, 2750, 3500, 'default-product.jpg', 1, 1),
(102, 'SPW-102', 6, 1, 'AICE Sundae Chocolate Cup 100 mL', 18, 4042, 5000, 'default-product.jpg', 1, 1),
(103, 'SPW-103', 6, 1, 'AICE Freezy Choco 49 mL', 0, 1560, 2000, 'default-product.jpg', 1, 1),
(104, '', 6, 1, 'AICE Bingo Cookies Cone 100 mL', 57, 4062, 4000, 'default-product.jpg', 1, 1),
...
(121, '', 4, 4, 'Roti Aoka', 1, 1800, 2500, 'default-product.jpg', 1, 1),
...
(136, '', 1, 4, 'Sui Botol 600ml', 469, 958, 2000, 'IMG_20220824_074621.jpg', 2, 1),
...
(188, '', 4, 4, 'Roti Aoka / Roti Coy', 30, 1800, 2500, 'default-product.jpg', 2, 1),
...
(199, '', 4, 4, 'Dilan 5 in 1', 12, 1567, 2000, 'default-product.jpg', 2, 1),
...
(208, '', 4, 4, 'Good Time', 53, 875, 1000, 'default-product.jpg', 2, 1),
(209, '', 4, 4, 'Goriorio', 60, 450, 500, 'default-product.jpg', 2, 1),
...
(213, '', 4, 4, 'Kalpa', 30, 1817, 2000, 'default-product.jpg', 2, 1),
(214, '', 4, 4, 'Keju Cake', 22, 1792, 2000, 'default-product.jpg', 2, 1),
...
(222, '', 4, 4, 'Nextar', 111, 1750, 2000, 'default-product.jpg', 2, 1),
...
(226, '', 4, 4, 'Roma Gandum Sandwich', 12, 1792, 2000, 'default-product.jpg', 2, 1),
...
(291, '', 6, 1, 'AICE Mochi Chocolate 45 ml', 39, 2313, 3000, 'default-product.jpg', 1, 1),
...
(294, '', 6, 1, 'AICE Mochi Vanila 45 ml', 36, 2313, 3000, 'default-product.jpg', 1, 1),
...
--
ALTER TABLE `tbl_franchise`
  MODIFY `id_franchise` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;

--
-- AUTO_INCREMENT for table `tbl_franchise_detail`
--
ALTER TABLE `tbl_franchise_detail`
  MODIFY `id_franchise_detail` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=252;

--
-- AUTO_INCREMENT for table `tbl_franchisor`
--
ALTER TABLE `tbl_franchisor`
  MODIFY `id_franchisor` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `tbl_product`
--
ALTER TABLE `tbl_product`
  MODIFY `id_product` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=361;
...
--
ALTER TABLE `tbl_purchase_detail`
  MODIFY `id_purchase_detail` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=284;
...
--
ALTER TABLE `tbl_selling`
  MODIFY `id_selling` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
...
--
ALTER TABLE `tbl_student_selling`
  MODIFY `id_student_selling` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `tbl_student_selling_detail`
--
ALTER TABLE `tbl_student_selling_detail`
  MODIFY `id_student_selling_detail` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
